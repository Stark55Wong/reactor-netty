...
public final class ReactorNetty {
	...
	static final class CompositeChannelPipelineConfigurer implements ChannelPipelineConfigurer {
		...
		@Override
		public void onChannelInit(Channel channel, ConnectionObserver connectionObserver, @Nullable SocketAddress remoteAddress) {
	...
	static final ChannelPipelineConfigurer NOOP_CONFIGURER = (conn, observer, remoteAddress) -> {};
